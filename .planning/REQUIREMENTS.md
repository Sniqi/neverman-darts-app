...
- [x] **DISP-03**: The Chromecast receiver (Chrome 90 @ 1280×720) renders the restyled display correctly — every modern CSS feature (container queries, dvh, subgrid) gated behind `@supports` with working fallbacks, verified on-device
