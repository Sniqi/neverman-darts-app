...
- [x] 06-02-PLAN.md — Installable/offline slice (PLAT-01/04): SvelteKitPWA plugin (registerType prompt, subpath scope/manifest, mp3 precache), disable SvelteKit SW, placeholder icons from logo.svg, manifest + ReloadPrompt mount, subpath build gate + manual install/offline verify
