...
- [x] 07-06-PLAN.md — RECV-05 score flash, VITE_CAST_APP_ID deploy wiring, SETUP-03 registration guide

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 07-02-PLAN.md — CastDisplayState projection (toDisplayState, isValidCastState) under the 32 KB cap (TDD)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 07-03-PLAN.md — CastSenderManager session state machine (availability, resume, auto-join) (TDD)
- [x] 07-04-PLAN.md — Receiver: isCastReceiverContext, CastReceiverBridge, receiveSnapshot ingress, /display wiring (TDD)
